...
public:
	...
	**/
	...
	/*!
		...
		@retval	結果:true接触 false非接触
	**/
	static bool CollisionCapsule(const CVector3D &top1,const CVector3D &bottom1,float radius1,const CVector3D &top2,const CVector3D &bottom2,float radius2,float *dist = nullptr,CVector3D *dir = nullptr);
	...
	**/
	...
	/*!
		...
		@retval	距離
	**/
	static float DistanceLine(const CVector3D &s1,const CVector3D &e1,const CVector3D &s2,const CVector3D &e2, CVector3D* dir=nullptr);
